  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="Solar Generation" value={kpiVal('Solar Generation', '847 GWh')} status="neutral" />
        <KPICard title="Capacity Factor" value={kpiVal('Capacity Factor', '18.4%')} status="neutral" />
        <KPICard title="Curtailment" value={kpiVal('Curtailment', '12%')} status="danger" />
        <KPICard title="Plants Active" value={kpiVal('Plants Active', '42')} status="neutral" />
      </div>
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="Tomorrow Forecast" value={kpiVal('Tomorrow Forecast', '24.2 GWh')} />
        <KPICard title="Irradiance Index" value={kpiVal('Irradiance Index', '5.4 kWh/m²')} />
        <KPICard title="Degradation Rate" value={kpiVal('Degradation Rate', '0.5%/yr')} />
      </div>
      <Chart
